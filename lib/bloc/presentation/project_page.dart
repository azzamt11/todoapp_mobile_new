...
import 'package:code/bloc/data/repository/project_repository.dart';
import 'package:code/bloc/domain/project/project_bloc.dart';
import 'package:code/bloc/presentation/widget/project_tab.dart';
...
class _ProjectPageState extends State<ProjectPage> {
  ...
  Widget projectBuilder(BuildContext context, ProjectState state) {
    ...
    if (state is ProjectLoaded) {
      return ProjectTab(projects: state.projects);
    }
